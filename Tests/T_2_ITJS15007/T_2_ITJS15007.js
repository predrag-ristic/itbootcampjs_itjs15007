...
console.log(`Cvecarka ima dovoljno ruza da posalje svakom kupcu po ${brRuzaPoKupcu}.`);
console.log(`Cvecarka treba da dokupi ${dokupiti} ruza kako bi ima dovoljno da posalje svakom kupcu po ${brRuzaPoKupcu + 1}.`);
